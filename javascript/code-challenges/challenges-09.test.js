...
const getNames = (arr) => {
  return arr.map(person => person.name.split('').reverse().join('')); // <---- GPT helped here.
};
...
// I found this stretch easier and more practical than the others. Not sure where my disconnect is with the other challenges.
