...
// I really struggled with this, had to resort to GPT for help. I understand the solution now, but I'm not sure I would have come up with it on my own.
const listFoods = (recipe) => {
  let result = [];
  recipe.ingredients.forEach(ingredient => {
    let firstSpaceIndex = ingredient.indexOf(' ');
    let restOfString = ingredient.slice(firstSpaceIndex + 1);
    let secondSpaceIndex = restOfString.indexOf(' ');
    let foodItem = restOfString.slice(secondSpaceIndex + 1);
